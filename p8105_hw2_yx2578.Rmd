...
* There are `r (filter(p2_df, vending == "NO" & entry == 1) %>% nrow() / filter(p2_df, vending == "NO") %>% nrow()) %>% round(digits = 4) * 100`% station entrances/exits without vending allow entrance.
